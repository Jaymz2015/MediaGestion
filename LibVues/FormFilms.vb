...
Imports MediaGestion.Metier.Bl.Blo.Impl
...
Public Class FormFilms
    ...
    Private mGestionnaireGenres As GestionnaireGenres
    ...
    Public Sub New(ByVal p_oControleur As CtrlFilms)
        ...
        mGestionnaireGenres = New GestionnaireGenres
...
#Region "Methodes privées"
    ...
    Private Sub Init()
        ...
        Try
            ...
            Me.CBGenre.DataSource = mGestionnaireGenres.ObtenirGenres()
            ...
            Dim gestionnaireFilms As GestionnaireFilms
            gestionnaireFilms = New GestionnaireFilms

            m_lListe = gestionnaireFilms.ObtenirFilms()
    ...
    Private Sub Affiche(ByVal f As Film)
        ...
        Try
            ...
            f = mGestionnaireFilms.ObtenirLeFilmComplet(f.Code)
            ...
            If Dir(m_sFolder + "\Pochettes\DVD\" + f.Photo) <> "" Then
                Me.PBPhoto.ImageLocation = m_sFolder + "\Pochettes\DVD\" + f.Photo
            ElseIf Dir(m_sFolder + "\Pochettes\DVD\Musique\" + f.Photo) <> "" Then
                Me.PBPhoto.ImageLocation = m_sFolder + "\Pochettes\DVD\Musique\" + f.Photo
            Else
    ...
    Private Sub AfficheSuite(ByVal f As Film)
        ...
        Try
            ...
            If f.LeGenre.Code = "DA" Or f.LeGenre.Code = "ANIM" Then
            ...
            l_bEstConcertOuClips = (f.LeGenre.Code = "LIVE" Or f.LeGenre.Code = "CLIP")
            ...
            Me.RtbResume.Text = f.Synopsys
            Me.TBrealisateur.Text = f.Realisateur
            Me.TBacteurs.Text = f.Acteurs
            ...
            Me.CBGenre.SelectedValue = f.LeGenre.Code
    ...
    Private Function LeFilm() As Film
        ...
        Try
            ...
            If Not m_lListe Is Nothing AndAlso m_lListe.Count > 0 Then
                ...
                'Return mGestionnaireFilms.ObtenirLeFilmComplet(m_lListe(m_iPosition).Code)
    ...
    '            l_sNomImage = Me.PBPhoto.ImageLocation.Split("\")(Me.PBPhoto.ImageLocation.Split("\").Length - 1)
    '        End If
    ...
    Private Sub ChercherFilm()
        ...
        Try
            ...
            If l_oDialogRecherche.ShowDialog() = Windows.Forms.DialogResult.OK Then
                ...
                Dim gestionnaire As GestionnaireFilms
                gestionnaire = New GestionnaireFilms

                m_ListeRecherche = gestionnaire.ObtenirFilms

                m_ListeRecherche = m_ListeRecherche.FindAll(AddressOf FindName)
    ...
    Private m_sNomFilm As String

    Public Function FindName(pMedia As Film) As Boolean

        If pMedia.Titre.ToUpperInvariant().Replace(" ", "").Contains(m_sNomFilm.ToUpperInvariant().Replace(" ", "")) Then
    ...
    Private Sub MAJchamps(ByVal p_oFilm As FicheFilmAllocine)
        ...
        Try
            ...
            l_sSouceFile = "C:\Temp\" + p_oFilm.NomPhoto
            Dim l_sDestFile As String
            l_sDestFile = m_sFolder + "\Pochettes\DVD\" + p_oFilm.NomPhoto
            ...
            If Dir(m_sFolder + "\Pochettes\DVD\" + p_oFilm.NomPhoto) <> "" Then
                Me.PBPhoto.ImageLocation = m_sFolder + "\Pochettes\DVD\" + p_oFilm.NomPhoto
            ElseIf Dir(m_sFolder + "\Pochettes\DVD\Musique\" + p_oFilm.NomPhoto) <> "" Then
                Me.PBPhoto.ImageLocation = m_sFolder + "\Pochettes\DVD\Musique\" + p_oFilm.NomPhoto
            Else
                Me.PBPhoto.ImageLocation = Nothing
            End If
...
#Region "Gestion des événements"
    ...
    Private Sub PBPhoto_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PBPhoto.Click
        ...
        Try
            Log.MonitoringLogger.Info(KS_NOM_MODULE + "Début PBPhoto_Click")
        ...
        Catch ex As Exception
            ...
            mGestionnaireFilms.TraiterErreur(KS_NOM_MODULE, "PBPhoto_Click", ex, True)

        Finally
            l_oDlgOuvrir = Nothing
            Log.MonitoringLogger.Info(KS_NOM_MODULE + "Fin PBPhoto_Click")
        End Try
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        l_oFilm = mGestionnaireFilms.ObtenirLeFilmComplet(l_oFilm.Code)
        ...
        im = New System.Drawing.Bitmap(m_sFolder + "\Pochettes\DVD\" + l_oFilm.Photo)
        ...
        EnTete = "Sortie : " & Format(l_oFilm.DateSortie, "d MMMM yyyy") & vbCrLf & _
                ...
                "Réalisateur : " & l_oFilm.Realisateur & vbCrLf
        If l_oFilm.LeGenre.Code = "ANIM" Or l_oFilm.LeGenre.Code = "DA" Then
            EnTete = EnTete & "Voix : " & l_oFilm.Acteurs & vbCrLf
        Else
            EnTete = EnTete & "Acteurs : " & l_oFilm.Acteurs & vbCrLf
        End If
        ...
        l_sMots = l_oFilm.Synopsys.Split
    ...
    Private Sub BtnAllocine_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAllocine.Click
        ...
        Try
            ...
            If l_oListeFichesFilmsAllocine.NbResultats > 0 Then
                ...
                l_oEcranRecherche = New FormSearch(l_oListeFichesFilmsAllocine)
        ...
        Try
            ...
            If Not m_bModeNew AndAlso m_bNouvelAffichagePossible AndAlso Not LeFilm() Is Nothing Then
                ...
                If sender Is CBGenre Then
                    ...
                    If CBGenre.SelectedValue <> LeFilm.LeGenre.Code Then
                        InfoSaisie.SetError(sender, "modification effectuée")
                        m_iNbModif += 1
                    Else
                        'Il y avait une erreur, il faut la supprimer
    ...
    Private Sub PBPhoto_LoadCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.AsyncCompletedEventArgs) Handles PBPhoto.LoadCompleted
        Log.MonitoringLogger.Info(KS_NOM_MODULE + "Début PBPhoto_LoadCompleted")
        ...
        Else
            ...
            If Not m_bModeNew AndAlso Not LeFilm() Is Nothing Then
                If Not PBPhoto.ImageLocation.Contains(LeFilm.Photo) Then
                    InfoSaisie.SetError(sender, "modification effectuée")
                    m_iNbModif += 1
                Else
                    'Il y avait une erreur, il faut la supprimer
        ...
        End If
        Log.MonitoringLogger.Info(KS_NOM_MODULE + "Fin PBPhoto_LoadCompleted")
    End Sub
        ...
        Try
            ...
            If Not m_bModeNew AndAlso m_bNouvelAffichagePossible AndAlso Not LeFilm() Is Nothing Then
                ...
                If sender Is TBacteurs Then
                    If TBacteurs.Text <> LeFilm.Acteurs Then
                        InfoSaisie.SetError(sender, "modification effectuée")
                        m_iNbModif += 1
                    Else
                        'Il y avait une erreur, il faut la supprimer
                ...
                If sender Is TBrealisateur Then
                    If TBrealisateur.Text <> LeFilm.Realisateur Then
                        InfoSaisie.SetError(sender, "modification effectuée")
                        m_iNbModif += 1
                    Else
                        'Il y avait une erreur, il faut la supprimer
                ...
                If sender Is RtbResume Then
                    If RtbResume.Text <> LeFilm.Synopsys Then
                        InfoSaisie.SetError(sender, "modification effectuée")
                        m_iNbModif += 1
                    Else
                        'Il y avait une erreur, il faut la supprimer

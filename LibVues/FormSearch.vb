...
Public Class FormSearch
    ...
    Public Sub New(ByVal p_oListe As List(Of Jeu))
    ...
    Public Sub New(ByVal p_oListe As List(Of Film))
    ...
    Public Sub New(ByVal pListeFichesFilmsAllocine As ListeFichesFilmsAllocine)
        ' Cet appel est requis par le Concepteur Windows Form.
        InitializeComponent()
        m_bModeJeu = False
    ...
    Public Sub New(ByVal pListeFichesJeuxJVC As ListeFichesJeuxJVC)
        ' Cet appel est requis par le Concepteur Windows Form.
        InitializeComponent()
        m_bModeJeu = True
        m_bModeRechercherWeb = True
    ...
    Private Sub initDGVrechercherAlloCineV2(ByVal pListeFichesFilmsAllocine As ListeFichesFilmsAllocine)
        ...
        Try
            ...
            l_oImageColumn.HeaderText = "Photo"
            ...
            For Each fiche As FicheFilmAllocine In listeFilmAllocine
                ...
                If Not fiche.LaPhoto Is Nothing AndAlso Not fiche.LaPhoto.Url Is Nothing Then
    ...
    Private Sub init_DataGridViewJeu()
        ...
        For Each j As Jeu In m_oListeJeux
            ...
            Select Case j.LaMachine.Code.ToUpper
                Case "PC"
            ...
            '    If g.Code.ToUpper = j.LeGenre.Code.ToUpper Then
            '        l_sGenre = g.Libelle
            '    End If
            'Next
            ...
            If Not j.Photo Is Nothing Then
                l_oJeu(1) = ObtenirThumbnail(j)
            Else
                l_oJeu(1) = Nothing
            End If
    ...
    Private Sub init_DataGridViewFilm()
        ...
        For Each f As Film In m_oListeFilms
            ...
            'On récupère le libellé du genre
            'For Each g As Genre In l_cGenres
            '    If g.Code.ToUpper = f.LeGenre.Code.ToUpper Then
            '        l_sGenre = g.Libelle
            '    End If
            'Next

            If Not f.Photo Is Nothing Then
                l_oFilm(1) = ObtenirThumbnail(f)
            Else
                l_oFilm(1) = Nothing
            End If
            ...
            l_oFilm(4) = Trim(f.LeGenre.Libelle)
    ...
    Public Function ObtenirThumbnail(p_oMedia As Media) As Image
        ...
        Try
            If p_oMedia.Photo <> vbNullString Then
                ...
                'End If
                If Dir(System.Environment.GetFolderPath(Environment.SpecialFolder.MyPictures) + "\Pochettes\DVD\" + p_oMedia.Photo) <> "" Then
                    l_sRepertoire = System.Environment.GetFolderPath(Environment.SpecialFolder.MyPictures) + "\Pochettes\DVD\"
                ElseIf Dir(System.Environment.GetFolderPath(Environment.SpecialFolder.MyPictures) + "\Pochettes\DVD\Musique\" + p_oMedia.Photo) <> "" Then
                ...
                If l_sRepertoire <> vbNullString Then
                    l_oImage = Image.FromFile(l_sRepertoire + p_oMedia.Photo)

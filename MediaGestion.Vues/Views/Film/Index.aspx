       ...
       <%-- <table class="nothing">
        ...
        <div id="conteneur">
                <div id="cadreFiltres">
                        ...
                        <!-- Choix genre --> 
                         <% foreach (var item in MediaGestion.Vues.DataManager.ObtenirListeGenre(MediaGestion.Modele.Constantes.EnumTypeMedia.FILM))
                            { %>
                            ...
                            <% foreach (var item in Model.ListeFilms)
                               { %>
                                ...
                                <tr>      
                                    ...
                                    <td>
                                        <%= Html.ActionLink(item.Titre, "Details", "Film", new { codeMedia = item.Code }, null)%>
                                    </td>
                                    <td>

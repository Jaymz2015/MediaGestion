...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% foreach (var item in Model) { %>
        ...
        <tr>
            <td>
                <% var imgurl = ""; if (item.LaPhoto != null) { imgurl = Url.Action("ThumbImage2", "Serie", new { url = item.LaPhoto.Url }); } %>               
            ...
            <td>
                <div class="display-field">
                    <%= Html.ActionLink("Créer fiche", "Create", new {codeSerieAllocine=item.Code}) %>
                </div>
            </td>
        </tr>

Public Class Prets
    ...
    Public Sub modifier(ByVal p As Pret)
        ...
        'TODO : voir si la mise à jour de toutes les colonnes est nécessaire ...
    ...
    'todo : Fonction qui retourne le nom d'un media en fonction de son code

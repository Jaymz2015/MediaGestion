...
#Region "Membres privés"
    ...
    Public Sub New(ByVal argTitre As String, ByVal argCodeGenre As String, ByVal argDuree As Integer, ByVal argDate As Date, _
        ...
        ByVal argJaquette As String, ByVal argNote As String, ByVal argDispo As Boolean, ByVal argProprietaire As Guid)
    ...
    Public Function ObtenirThumbnail() As Image
        ...
        Try
            If Me.Jaquette <> vbNullString Then

                'TODO : à virer du métier
                'If Dir("\\" & System.Environment.MachineName & "\Images" + "\Pochettes\DVD\" + Jaquette) <> "" Then
                '    l_sRepertoire = "\\" & System.Environment.MachineName & "\Images" + "\Pochettes\DVD\"
                'ElseIf Dir("\\" & System.Environment.MachineName & "\Images" + "\Pochettes\DVD\Musique\" + Jaquette) <> "" Then
                '    l_sRepertoire = "\\" & System.Environment.MachineName & "\Images" + "\Pochettes\DVD\Musique\"
                'Else
                '    l_sRepertoire = Nothing
                'End If
                If Dir(System.Environment.GetFolderPath(Environment.SpecialFolder.MyPictures) + "\Pochettes\DVD\" + Jaquette) <> "" Then
                    l_sRepertoire = System.Environment.GetFolderPath(Environment.SpecialFolder.MyPictures) + "\Pochettes\DVD\"
                ElseIf Dir(System.Environment.GetFolderPath(Environment.SpecialFolder.MyPictures) + "\Pochettes\DVD\Musique\" + Jaquette) <> "" Then
                ...
                If l_sRepertoire <> vbNullString Then
                    l_oImage = Image.FromFile(l_sRepertoire + Me.Jaquette)

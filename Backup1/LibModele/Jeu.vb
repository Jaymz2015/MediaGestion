...
#Region "Constructeurs"
    ...
    Public Sub New(ByVal argTitre As String, ByVal argCodeGenre As String, ByVal argCodeMachine As String, _
         ByVal argEditeur As String, ByVal argDeveloppeur As String, ByVal argDate As Date, ByVal argJaquette As String, ByVal argNote As String, _
    ...
    Public Function ObtenirThumbnail() As Image
        ...
        Try
            If Me.Jaquette <> vbNullString Then
                ...
                If Dir(System.Environment.GetFolderPath(Environment.SpecialFolder.MyPictures) + "\Pochettes\Jeux\" + Jaquette) <> "" Then

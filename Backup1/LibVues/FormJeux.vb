...
#Region "Methodes privées"
    ...
    Private Sub affiche2(ByVal j As Jeu)
        ...
        Me.TBDeveloppeur.Text = j.Developpeur
...
#Region "Gestion des événements"
    ...
    Private Sub MAJchamps(ByVal p_oJeu As FicheJeuJVC)
        ...
        Try
            ...
            l_sSouceFile = "C:\Temp\" + p_oJeu.NomJaquette
            Dim l_sDestFile As String
            l_sDestFile = m_sFolder + "\Pochettes\Jeux\" + p_oJeu.NomJaquette
            ...
            If Dir(m_sFolder + "\Pochettes\Jeux\" + p_oJeu.NomJaquette) <> "" Then
                Me.PBJaquette.ImageLocation = m_sFolder + "\Pochettes\Jeux\" + p_oJeu.NomJaquette
            Else
                Me.PBJaquette.ImageLocation = Nothing
            End If

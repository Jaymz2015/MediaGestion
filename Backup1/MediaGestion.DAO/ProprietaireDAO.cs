...
namespace MediaGestion.DAO
{
    public class ProprietaireDAO
    {
        ...
        /// </summary>
        public string REQUETE_OBTENIR_PROPRIETAIRE = "SELECT code, login, passwordHash, nom, prenom, adresse, cp, ville, habilitation FROM PROPRIETAIRE where login = @pLogin";

    ...
    <h2>Ajout film</h2>
        ...
        <%= Html.ValidationSummary(true) %>
             ...
             <% 
                 ...
                 if (!String.IsNullOrEmpty(this.Model.LeFilm.Jaquette))
                 {
                     imgurl = Url.Action("ThumbImage", "Film",
                                                 new { jaquette = this.Model.LeFilm.Jaquette, width = 100, height = 600 });
...
--%>
        ...
        <p>
           <input type="submit" name="creerExemplaire" value="Créer exemplaire" />   <input type="submit" name="creerSouhait" value="Add to wish list"  />
        </p>

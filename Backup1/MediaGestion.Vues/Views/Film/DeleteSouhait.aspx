...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3>Etes vous sûr de vouloir supprimer ce film de la liste des souhaits de <b><%= Html.Encode(Model.LeProprietaire.Prenom)%> <%= Html.Encode(Model.LeProprietaire.Nom)%></b> : <b><%= Html.Encode(Model.LeMedia.Titre)%></b> ?</h3>

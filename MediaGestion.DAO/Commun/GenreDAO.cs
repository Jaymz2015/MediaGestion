...
namespace MediaGestion.DAO
{
    public class GenreDAO
    {
        ...
        /// </summary>
        private string REQUETE_OBTENIR_LISTE_GENRES = "SELECT codeGenre, libelle, media FROM GENRE order by libelle ";

        /// <summary>
        /// Requête de récupération d'un Genre
        /// </summary>
        private string REQUETE_OBTENIR_GENRE = "SELECT codeGenre, libelle, media FROM GENRE where codeGenre=@pCode";

...
namespace MediaGestion.DAO
{
    public class GenreRowMapper : RowMapper<Genre>
    {
        ...
        {
            Genre leGenre = new Genre(pReader.GetString(pReader.GetOrdinal("codeGenre")), pReader.GetString(pReader.GetOrdinal("libelle")), pReader.GetByte(pReader.GetOrdinal("media")));

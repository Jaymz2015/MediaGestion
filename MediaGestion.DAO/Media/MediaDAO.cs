...
namespace MediaGestion.DAO
{
    public class MediaDAO
    {
        ...
        /// </summary>
        private string REQUETE_OBTENIR_LISTE_MEDIAS = "SELECT f.code, titre, duree, f.codeGenre, f.ficheAllocine, g.libelle, dateSortie, resume, " +
        ...
        /// <summary>
        /// Requête de suppression d'un media (cascade)
        /// </summary>
        private string REQUETE_SUPPRIMER_MEDIA = "DELETE from MEDIA WHERE code=@codeMedia";
        ...
        /// </summary>
        private string REQUETE_OBTENIR_LISTE_EXEMPLAIRES_FILM = "select f.code codeFilm, f.titre titreFilm, f.ficheAllocine, f.codeGenre codeGenre, g.libelle libelleGenre, g.media, f.jaquette jaquette, f.dateCreation, p.code codeProprio, p.nom nom, p.prenom prenom, s.code codeSupport, s.libelle libelleSupport, " +
                                                                " ex.dateAcquisition, emp.codeEmprunteur codeEmprunteur, emp.nom nomEmprunteur, emp.prenom prenomEmprunteur, emp.datePrete, case when emp.datePrete is not null and emp.dateRendu is null then 0 else 1 end as dispo " +
        ...
        /// </summary>
        private string REQUETE_OBTENIR_LISTE_SOUHAITS_FILM = "select f.code codeFilm, f.titre titreFilm, f.codeGenre codeGenre, g.libelle libelleGenre, g.media, f.jaquette jaquette, p.code codeProprio, p.nom nom, p.prenom prenom, s.code codeSupport, s.libelle libelleSupport " +
        ...
        /// Requête de récupération de la liste des souhaits d'un propriétaire
        /// </summary>
        private string REQUETE_OBTENIR_LISTE_SOUHAITS_PROPRIETAIRE = "select f.code codeFilm, f.titre titreFilm, f.codeGenre codeGenre, g.libelle libelleGenre, g.media, f.jaquette jaquette, p.code codeProprio, p.nom nom,  " +
        ...
        /// </summary>
        private string REQUETE_MODIFIER_EXEMPLAIRE = "UPDATE [CatalogueMedias].[dbo].[EXEMPLAIRE_FILM] SET codeSupport=@codeSupport, dateAcquisition=@dateAcquisition " +
                                                        " WHERE codeProprietaire=@codeProprietaire AND codeFilm=@codeFilm AND codeSupport=@codeSupport2";
        ...
        /// <param name="pCode">code film</param>
        /// <returns>Le film trouvé en base</returns>
        public Film CreerFilmEtExemplaire(Film pFilm, string pCodeSupport, Guid pCodeProprietaire, DateTime pDateAcquisition)
        {
            ...
            try
            {
                ...
                maDataSource.ExecuterDML(REQUETE_AJOUTER_EXEMPLAIRE, true, pCodeProprietaire, pFilm.Code, pCodeSupport, DateTime.Now, pDateAcquisition);

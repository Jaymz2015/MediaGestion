...
{
    public class DeveloppeurRowMapper : RowMapper<Developpeur>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Developpeur ExtraireDonneesReader(System.Data.SqlClient.SqlDataReader pReader)
        {
            ...
            try
            {
                ...
                developpeur.Code = pReader.GetGuid(pReader.GetOrdinal("code"));
                developpeur.Nom = pReader.GetString(pReader.GetOrdinal("nom"));
            ...
            {
                throw new Exception("Erreur lors de la conversion de l'objet developpeur : " + ex.Message);
            }
        }
    }
}

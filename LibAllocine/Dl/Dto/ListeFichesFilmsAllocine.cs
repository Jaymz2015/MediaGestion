...
namespace LibAllocine.Dl.Dto
{
    ...
    public class ListeFichesFilmsAllocine
    {
        ...
        [XmlElement("tvseries")]
        public FicheFilmAllocine[] LesFichesSeries;
        ...
        /// </summary>
        /// <returns></returns>
        public List<FicheFilmAllocine> ObtenirListeSeries()
        {

            List<FicheFilmAllocine> liste = new List<FicheFilmAllocine>();

            if (LesFichesSeries != null)
            {
                liste = new List<FicheFilmAllocine>(LesFichesSeries);

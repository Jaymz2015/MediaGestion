...
Public Class Films
    ...
    Public Overridable Function obtenirListe(ByVal g As String) As List(Of Film)
        ...
        Try
            ...
            Me.SqlSelectCommand2.CommandText = "SELECT code, titre, duree, codeGenre, dateSortie, synopsys, jaquette, realisateur," _
    ...
    Public Overridable Function chercherFilms(ByVal p_sTitre As String, ByVal p_sGenre1 As String, _
        ...
        Try
            ...
            l_sRequete = "SELECT code, titre, duree, codeGenre, dateSortie, synopsys, jaquette," _
    ...
    Public Overridable Function chercherFilmsaAvoir() As List(Of Film)
        ...
        Try
            ...
            'Construction de la requête
            l_sRequete = "SELECT f.code, titre, duree, codeGenre, dateSortie, synopsys, jaquette," _
    ...
    Public Sub ajouter(ByVal f As Film)
        ...
        Try
            ...
            dr(0)("synopsys") = f.LeResume
            dr(0)("jaquette") = f.Photo
    ...
    Private Sub InitializeComponent()
        ...
        {New System.Data.Common.DataTableMapping("Film", "Films", New System.Data.Common.DataColumnMapping() _
          {New System.Data.Common.DataColumnMapping("code", "Code"), _
            New System.Data.Common.DataColumnMapping("titre", "Titre"), _
             ...
             New System.Data.Common.DataColumnMapping("synopsys", "Resume"), _
        ...
        'SqlInsertCommand1
        '-------------------
        Me.SqlInsertCommand1.CommandText = "INSERT INTO FILM(code, titre, duree, codeGenre, dateSortie, synopsys," & _
        "jaquette, realisateur, acteurs, support, dispo, note, codeProprietaire) VALUES (@code, @titre, @duree, @genre, @sortie," & _
        "@synopsys, @jaquette, @realisateur, @acteurs, @support, @dispo, @note, @proprietaire);"
        ...
        Me.SqlInsertCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@synopsys", System.Data.SqlDbType.VarChar, 1500, "synopsys"))
        ...
        'SqlSelectCommand1
        '-------------------
        Me.SqlSelectCommand1.CommandText = "SELECT code, titre, duree, codeGenre, dateSortie, synopsys, jaquette, realisateur," _
        ...
        "dateSortie = @dateSortie, synopsys = @synopsys, jaquette = @jaquette, realisateur = @realisateur, acteurs = @acteurs," & _
        ...
        Me.SqlUpdateCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@synopsys", System.Data.SqlDbType.VarChar, 1500, "synopsys"))

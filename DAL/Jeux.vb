Public Class Jeux
    ...
    Public Overridable Function obtenirListe(ByVal p_sCodeGenre As String, ByVal p_sCodeMachine As String) As List(Of Jeu)
        ...
        l_sRequete = "SELECT code, titre, codeMachine, codeGenre, dateSortie, jaquette," _
                 & "editeur, developpeur, dispo, note, etatBoitier, etatLivret, etatJeu,estCopie FROM Jeux"
    ...
    Public Overridable Function chercherJeux(ByVal p_sTitre As String, ByVal p_sMachine As String, _
        ...
        l_sRequete = "SELECT code, titre, codeMachine, codeGenre, dateSortie, jaquette," _
         & "editeur, developpeur, dispo, note, etatBoitier, etatLivret, etatJeu,estCopie FROM Jeux where titre like '%" _
         + p_sTitre + "%'"
    ...
    'Fonction qui retourne la liste des jeux à acquérir
    Public Overridable Function chercherJeuxaAvoir() As List(Of Jeu)
        ...
        'Construction de la requête
        'l_sRequete = "SELECT j.code, titre, codeMachine, codeGenre, dateSortie, jaquette," _
        '& "editeur, developpeur, dispo, note, etatBoitier, etatLivret, etatJeu,estCopie " _
        '& "FROM JEUX j where not exists (select p.codeJeu from PRETS p where j.code = p.codeJeu)  and j.dispo = 0 order by titre"

        l_sRequete = "SELECT j.code, titre, codeMachine, codeGenre, dateSortie, jaquette," _
        & "editeur, developpeur, dispo, note, etatBoitier, etatLivret, etatJeu,estCopie " _
        & "FROM JEUX j where j.dispo = 0 order by titre"
    ...
    Public Sub ajouter(ByVal j As Jeu)
        ...
        dr(0)("jaquette") = j.Photo
        dr(0)("dispo") = j.Dispo
        dr(0)("note") = j.Note
        dr(0)("editeur") = j.Editeur
        dr(0)("developpeur") = j.Developpeur
    ...
    Private Sub InitializeComponent()
        ...
        {New System.Data.Common.DataTableMapping("Jeux", "Jeux", New System.Data.Common.DataColumnMapping() _
          {New System.Data.Common.DataColumnMapping("code", "Code"), _
            ...
            New System.Data.Common.DataColumnMapping("jaquette", "Photo"), _
            New System.Data.Common.DataColumnMapping("editeur", "Editeur"), _
            New System.Data.Common.DataColumnMapping("developpeur", "Developpeur"), _
        ...
        "jaquette, editeur, developpeur, dispo, note, etatBoitier, etatLivret, etatJeu,estCopie) VALUES (@code, @titre, @codeMachine, @genre, @sortie," & _
        "@jaquette, @editeur, @developpeur, @dispo, @note,@etatBoitier, @etatLivret, @etatJeu, @estCopie );"
        ...
        Me.SqlInsertCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@developpeur", System.Data.SqlDbType.VarChar, 30, "developpeur"))
        ...
        Me.SqlSelectCommand1.CommandText = "SELECT code, titre, codeMachine, codeGenre, dateSortie, jaquette, editeur," _
         & "developpeur, dispo, note, etatBoitier, etatLivret,etatJeu,estCopie FROM Jeux order by titre"
        ...
        "dateSortie = @dateSortie, jaquette = @jaquette, editeur = @editeur, developpeur = @developpeur, dispo= @dispo, note= @note," & _
        ...
        Me.SqlUpdateCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@developpeur", System.Data.SqlDbType.VarChar, 50, "developpeur"))
